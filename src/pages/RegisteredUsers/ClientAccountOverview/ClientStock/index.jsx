...
export default function ClientStock() {
  ...
  const handleEdit = async (stock) => {
    navigate(`/dashboard/registered_users/view/view_stocks_details/edit_stock/${userId}`, {
      ...
      <div className="sm:flex sm:items-center">
        ...
        <div className="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
          <button
            ...
            onClick={() =>
              navigate(`/dashboard/registered_users/view/view_stocks_details/add_stock/${userId}`)
            }
          >
            Add Stock
          </button>
          ...
          <table className="min-w-full divide-y divide-gray-300">
            <thead>
              <tr>
                <th
                  scope="col"
                  className="pr-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell"
                >
                  SYM
                </th>
                <th
                  scope="col"
                  className="hidden pr-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell"
                >
                  Company
                </th>
                <th
                ...
                <th
                  scope="col"
                  className=" pr-3 py-3.5 text-left text-sm font-semibold text-gray-900 lg:table-cell"
                >
                  Shares
                </th>
                <th
                  scope="col"
                  className="hidden pr-3 py-3.5 text-left text-sm font-semibold text-gray-900 sm:table-cell"
                >
                  TP
                </th>
                <th
                ...
                <th
                  scope="col"
                  className="hidden pr-3 py-3.5 text-left text-sm font-semibold text-gray-900 xl:table-cell"
                >
                  Date
                </th>
                ...
                <tr key={index}>
                  <td className="w-full max-w-0 py-4 pl-4 pr-3 text-sm font-medium text-gray-900 sm:w-auto sm:max-w-none capitalize sm:pl-0">
                    ...
                    <dl className="font-normal lg:hidden">
                      ...
                      <dd className="mt-1 truncate max-w-12 text-gray-700 lg:hidden">
                        {stock.companyName}
                      </dd>
                    ...
                    <dl className="font-normal xl:hidden">
                      ...
                      <dd className="mt-1 max-w-12 truncate text-gray-700 xl:hidden">
                        {stock.tradeDate}
                      </dd>
                    </dl>
                  </td>
