...
export default function PortfolioInfo({ initialUser }) {
  ...
  const cards = [
    ...
    {
      name: "Bonds balance",
      href: `registered_users/view/edit_bonds_details/${userId}`,
      icon: ScaleIcon,
      amount: amount,
    },
    {
      name: "IPOs balance",
      href: `registered_users/view/edit_ipos_details/${userId}`,
      icon: ScaleIcon,
      amount: amount,
    },
    {
      name: "Terms balance",
      href: `registered_users/view/edit_terms_details/${userId}`,
      icon: ScaleIcon,
      amount: amount,
    },
    {
      name: "Stocks balance",
      href: `registered_users/view/edit_stocks_details/${userId}`,
      icon: ScaleIcon,
      amount: amount,
    },
  ];
