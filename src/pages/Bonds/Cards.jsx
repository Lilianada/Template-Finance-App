            ...
            >
              <div className="flex items-center gap-x-4 border-b border-gray-900/5 bg-gray-50 p-4 flex-col">
                <Menu as="div" className="relative ml-auto">
                  <Menu.Button className="block text-gray-400 hover:text-indigo-500" onClick={() => setOpen(true)}>
              ...
              <dl className="divide-y divide-gray-100 px-4 py-4 text-sm leading-6">
                ...
                <div className="flex justify-between gap-x-4 py-3">
                  ...
                  <dd className="flex items-start gap-x-2">
                    ...
                    <Link to={bond.companyWebsite} className="font-medium text-indigo-700 cursor-pointer hover:text-indigo-400 rounded-md py-1 px-2 text-xs ring-1 ring-inset">
                      URL
                    </Link>
                  </dd>
                </div>
