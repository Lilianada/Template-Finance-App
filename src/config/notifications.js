...
import {
  ...
  export async function deleteAllNotifications() {
    const adminDashRef = collection(db, "adminUsers");
    const notificationDashRef = doc(adminDashRef, "notifications");
    ...
    const chatNotificationsRef = collection(notificationDashRef, "chatNotifications");
    const bondNotificationsRef = collection(notificationDashRef, "bondNotifications");
    const iposNotificationsRef = collection(notificationDashRef, "iposNotifications");
    const termsNotificationsRef = collection(notificationDashRef, "termsNotifications");
