            ...
            <div className="ml-10 flex flex-shrink-0 items-center space-x-10 pr-4">
              <nav aria-label="Global" className="flex space-x-10">
                {navigation.map((item) =>
                  item.children.length ? (
                    ...
                    <Link key={item.name} to={item.href} className="text-sm font-medium text-gray-900">
                      {item.name}
                    </Link>
                  )
                )}
              ...
              <div className="flex items-center space-x-8">
                <span className="inline-flex">
                  <Link to="#" className="relative -mx-1 rounded-full bg-white p-1 text-gray-400 hover:text-gray-500">
                    ...
                    {messages.map((message) => (
                      ...
                      >
                        <div className="flex justify-between space-x-3">
                          <div className="min-w-0 flex-1">
                            <Link to={message.href} className="block focus:outline-none">
